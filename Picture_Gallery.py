...
title1.place(x = 30, y = 40, width = 100, height = 25)
artistname = Entry(text = "")
artistname.place(x = 130, y = 40, width = 180, height = 25)
artistname.focus()
...
addbtn.place(x = 130, y = 80, width = 130, height = 25)
clearbtn = Button(text = "Clear Artist", command = clearartist)
clearbtn.place(x = 280, y = 80, width = 130, height = 25)

artnamelbl = Label(text = "Artist ID: ")
artnamelbl.place(x = 30, y = 120, width = 80, height = 25)
artname = Entry(text = "")
artname.place(x = 130, y = 120, width = 150, height = 25)
...
addartbtn.place(x = 130, y = 150, width = 130, height = 25)
clearartbtn = Button(text = "Clear Piece", command = clearartist)
clearartbtn.place(x = 280, y = 150, width = 130, height = 25)

outputwindow = Listbox()
outputwindow.place(x = 50, y = 200, width = 960, height = 350)
